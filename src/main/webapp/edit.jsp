<%@page import="com.entity.AttendanceDetails"%><%@page import="com.db.*"%>
<%@page import="com.dao.*"%>
			...
			<div class="col-md-6 offset-md-3">
				<div class="card">
					<div class="card-body" style="border: 3px solid black;">
						<h3 class="text-center text-success">Update Student</h3>
						
						
						<%
						int id=Integer.parseInt(request.getParameter("id"));
						AttendanceDAO dao=new AttendanceDAO(DBConnect.getConn());
						AttendanceDetails t=dao.getAttendanceid(id);
						%>
